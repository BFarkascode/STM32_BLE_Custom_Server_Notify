...
uint8_t a_AdvData[7] =
{
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'W', 'B', '5', 'M', 'M',  /* Complete name */
...
int32_t bmp280_get_temp(void){
	  ...
	  I2CReadout(0x77, 6, &T_comp);												//we read out the temperature compensation parameters  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	  	//address is hard-wired to be 0x77 currently
	  ...
	  I2CReadout(0x77, 3, &T_out);												//we read out the temperature compensation parameters
	  ...
	  sprintf(str, "%u", temperature/100);

	  ssd1315_advance_string(0, 0, str, 10, 1, 0x10);						//print to screen
